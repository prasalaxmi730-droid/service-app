...
export const initDB = async () => {
  ...
  // Create tables using MSSQL syntax
  ...
  await pool.request().query(`
    IF NOT EXISTS (SELECT * FROM sys.objects WHERE type = 'TR' AND name = 'trg_service_report_insert_complete_call')
    EXEC('
